...
<head>
    ...
    <style>
        ...
        /* Navigasi Konsisten dengan 3 Menu */
        nav { 
            background: white; 
            padding: 15px 20px; 
            display: flex; 
...
<body>
    ...
    <nav>
        ...
        <a href="/stok" class="nav-link" style="opacity: 0.5;">
            <span style="font-size: 20px;">📦</span>
            <span class="nav-label">STOK</span>
        </a>
        <a href="/laporan-keuntungan" class="nav-link active">
            <span style="font-size: 20px;">📊</span>
    ...
    <div class="container">
        ...
        <div style="padding: 0 5px;">
            <a href="/download-pdf" class="btn-pdf">
                <span>📥</span>
