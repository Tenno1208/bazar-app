...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        /* Toast Alert */
        .toast { position: fixed; top: 20px; left: 50%; transform: translateX(-50%); background: white; padding: 15px 25px; border-radius: 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); z-index: 10001; display: flex; align-items: center; gap: 10px; font-weight: 700; font-size: 14px; animation: slideIn 0.5s forwards; border-left: 5px solid var(--primary); }
        ...
        input, select { width: 100%; padding: 14px; margin-top: 8px; border-radius: 12px; border: 1.5px solid #e2e8f0; background: #f1f5f9; font-size: 16px; }
        ...
        .btn-del { background: #fff1f2; color: #e11d48; border: none; padding: 8px 12px; border-radius: 10px; margin-left: 10px; font-weight: bold; }
...
<body>
    ...
    @if(session('success'))
    <div class="toast" id="toast-success" style="border-left-color: var(--success);">
        <span>✅</span> {{ session('success') }}
    </div>
    @endif

    @if(session('error') || $stok <= 0)
    <div class="toast" id="toast-error" style="border-left-color: var(--danger);">
