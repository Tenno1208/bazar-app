...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Salad POS">

    <link rel="apple-touch-icon" href="{{ asset('img/logo.png') }}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('img/logo.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('img/logo.png') }}">
    
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('img/logo.png') }}">
    <link rel="icon" type="image/png" sizes="512x512" href="{{ asset('img/logo.png') }}">
