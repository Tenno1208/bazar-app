    ...
    public function index()
{
    ...
    $countCash = Transaksi::where('metode', 'cash')->count(); // Tambahkan ini
    
    // firstOrCreate akan mencari 'Salad Buah'. Jika tidak ada, dia akan membuatnya.
    // Pastikan fillable di model sudah ada agar baris ini tidak error.
